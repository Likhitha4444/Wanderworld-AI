...
export const CompassIcon = ({ className = "w-6 h-6", style = {} }) => (
...
export const SparklesIcon = ({ className = "w-6 h-6", style = {} }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const ShieldIcon = ({ className = "w-6 h-6", style = {} }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const ArrowRightIcon = ({ className = "w-5 h-5", style = {} }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const MenuIcon = ({ className = "w-6 h-6", style = {} }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const CloseIcon = ({ className = "w-6 h-6", style = {} }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const GlobeIcon = ({ className = "w-6 h-6", style = {} }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    <circle cx="12" cy="12" r="10"></circle>
...
export const PlaneIcon = ({ className = "w-4 h-4", style = {} }) => (
...
export const HeartIcon = ({ className = "w-5 h-5", style = {}, filled = false }) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
